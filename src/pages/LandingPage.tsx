...
// Discord brand icon component with forwardRef for Button compatibility
...
const LandingPage = () => {
  ...
  // ✅ New auth flow: backend redirect
      ...
      <footer className="relative z-10 border-t border-border/50 bg-background/50 backdrop-blur-xl">
        <div className="container mx-auto px-6 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-muted-foreground">© 2024 SoundWave. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
